...
# permet de définir des classes de base, qui ne peuvent être instanciée
...
# début de ma modification
class ImageFileGif(ImageFile):

   """ def __init__(self, type_d_image):
        super().__init__()
        self.type_d_imade = type_d_image"""
    ...
    #super.display(self.type_d_imade)

class ImageFileJpg(ImageFile):
    pass
# fin modification
